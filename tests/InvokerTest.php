...
class InvokerTest extends TestCase
{
     ...
     * @expectedExceptionMessage Chiron\Invoker\Tests\InvokerTestFixture::bar() is not a callable.
     */
     ...
     * @test
     * @expectedException \Chiron\Invoker\Exception\NotCallableException
     * @expectedExceptionMessage Chiron\Invoker\Tests\InvokerTestMagicMethodFixture::foo() is not a callable. A __call() method exists but magic methods are not supported.
     */
    ...
    {
        $result = $this->invoker->call(array('Chiron\Invoker\Tests\InvokerTestStaticFixture', 'foo'));
    ...
    {
        $result = $this->invoker->call('Chiron\Invoker\Tests\InvokerTestStaticFixture::foo');
        $this->assertEquals('bar', $result);
    }
    /**
     * @test
    ...
    {
        $callable = new CallableSpy;
        $this->container->add('thing-to-call', $callable);
    ...
    public function should_resolve_array_callable_from_container_with_class_name()
    {
        ...
        $result = $this->invoker->call(array('Chiron\Invoker\Tests\InvokerTestFixture', 'foo'));
        $this->assertEquals('bar', $result);
        $this->assertTrue($fixture->wasCalled);
    }
    /**
    ...
    public function should_resolve_callable_from_container_with_class_name_in_scope_resolution_syntax()
    {
        $fixture = new InvokerTestFixture;
        $this->container->add('Chiron\Invoker\Tests\InvokerTestFixture', $fixture);
        $result = $this->invoker->call('Chiron\Invoker\Tests\InvokerTestFixture::foo');
        $this->assertEquals('bar', $result);
        $this->assertTrue($fixture->wasCalled);
    }
    /**
     * @test
     * @expectedException \Chiron\Invoker\Exception\NotCallableException
     * @expectedExceptionMessage Cannot call Chiron\Invoker\Tests\InvokerTestFixture::foo() because foo() is not a static method and "Chiron\Invoker\Tests\InvokerTestFixture" is not a container entry
     */
    public function should_not_invoke_statically_a_non_static_method()
    {
        $this->invoker->call(array('Chiron\Invoker\Tests\InvokerTestFixture', 'foo'));
    }
    /**
     * @test
     */
    public function should_invoke_static_method_rather_than_resolving_entry_from_container()
    {
        ...
        $this->container->add('Chiron\Invoker\Tests\InvokerTestStaticFixture', 'foobar');
